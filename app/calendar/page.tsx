          ...
          <div className="flex-1 bg-white p-6 overflow-y-auto">
            <div className="grid grid-cols-7 border-l border-t border-slate-100 h-full min-h-[600px]">
              ...
              {['일', '월', '화', '수', '목', '금', '토'].map((day, i) => (
                <div
                  key={day}
                  className={`p-3 text-center text-xs font-bold border-r border-b border-slate-100 bg-slate-50/50 ${
              ...
              {Array.from({ length: daysInMonth }).map((_, i) => {
                ...
                return (
                  <div
                    ...
                    className={`min-h-[100px] p-2 border-r border-b border-slate-100 cursor-pointer transition-colors ${
                      isSelected ? 'bg-[var(--color-primary)]/5' : 'hover:bg-slate-50'
                    }`}
                  >
                    {isToday ? (
